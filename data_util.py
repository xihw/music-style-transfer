...
def load(style):
    ...
    for filename in os.listdir(data_folder):
        ...
        matrix_x, matrix_y = parse(filepath)
        if X is None:
            X = matrix_x
        else:
    ...
    print('X shape:', X.shape) # 349 examples, 500 timestamps, 88 pitchs
...
def parse(a_file):
    ...
    matrix_x = ((pianoroll[1000:1500, 21:109] > 0) * 1).reshape(1, 500, 88)
    matrix_y = pianoroll[1000:1500, 21:109].reshape(1, 500, 88)     
